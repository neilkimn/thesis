...
/home/neni/.conda/envs/pt/bin/python /home/neni/repos/thesis/src/shared_queues/train_multiple_timm.py \
    --arch $MODEL --epochs $EPOCHS --pretrained true --lr 0.1 --data-dir $DATA_DIR$DATASET \
    --num-processes 1 --batch-size $BATCH_SIZE --training-workers 12 --validation-workers 8 --num-classes 1000 \
    --gpu-prefetch \
    --log_dir "${LOG_DIR}/${DATASET}/${MODEL_NAME}" $1 --record_first_batch_time &
training_main_proc=$!
