...
/home/ubuntu/miniconda3/envs/thesis/bin/python src/shared_queues/train_multiple.py \
    --arch resnet18 resnet18 resnet34 resnet34 resnet50 resnet50 --epochs $EPOCHS --pretrained true true true true true true --dataset $DATASET \
    --num-processes 6 --batch-size $BATCH_SIZE --training-workers 16 --validation-workers 1 \
