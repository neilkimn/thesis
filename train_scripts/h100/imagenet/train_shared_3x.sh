...
/home/neni/.conda/envs/pt/bin/python /home/neni/repos/thesis/src/shared_queues/train_multiple_timm.py \
    --arch $MODEL $MODEL $MODEL --epochs $EPOCHS --pretrained true true true --lr 0.1 --data-dir $DATA_DIR$DATASET \
    --num-processes 3 --batch-size $BATCH_SIZE --training-workers 12 --validation-workers 8 --num-classes 1000 \
    --gpu-prefetch \
