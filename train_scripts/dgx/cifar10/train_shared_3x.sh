...
/home/neni/.conda/envs/thesis/bin/python src/shared_queues/train_multiple.py \
    --arch resnet18 resnet18 resnet18 --epochs $EPOCHS --pretrained true true true --dataset $DATASET \
    --num-processes 3 --batch-size $BATCH_SIZE --training-workers $WORKERS --validation-workers 1 \
